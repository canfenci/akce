...
export default function App() {
  ...
  const screen = page === 'home' ? <HomeScreen goTo={navigate} /> : page === 'expenses' ? <ExpensesScreen openQuick={() => setQuickOpen(true)} /> : page === 'budget' ? <BudgetScreen /> : page === 'investments' ? <InvestmentsScreen /> : page === 'assets' ? <AssetsScreen /> : page === 'coach' ? <CoachScreen /> : <SettingsScreen />;
