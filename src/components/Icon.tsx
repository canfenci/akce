...
export type IconName = 'home' | 'wallet' | 'plus' | 'target' | 'spark' | 'settings' | 'menu' | 'close' | 'arrow' | 'receipt' | 'chart' | 'check' | 'trash' | 'calendar' | 'card';
...
const paths: Record<IconName, React.ReactNode> = {
  ...
  chart: <><path d="M4 20V10M10 20V4M16 20v-7M22 20H2"/></>, check: <path d="m5 12 4 4L19 6"/>, trash: <><path d="M4 7h16M9 7V4h6v3M7 7l1 14h8l1-14"/></>,
